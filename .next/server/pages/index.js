...
function MeetupList({
  ...
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])("ul", {
    ...
    children: meetups.map(meetup => /*#__PURE__*/Object(jsx_runtime_["jsx"])(meetups_MeetupItem, {
      id: meetup.id,
      image: meetup.image,
      title: meetup.title,
...
async function getStaticProps() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Karthick:TheRock07@cluster0.n9nyb.mongodb.net/MeetupsDatabase?retryWrites=true&w=majority");
  const db = client.db();
